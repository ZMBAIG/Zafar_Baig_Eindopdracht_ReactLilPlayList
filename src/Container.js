...
class Container extends React.Component {
  ...
  addNewItem() {
    ...
    if (someInputIsEmpty) {
      alert(
        "Please type in Song Title and Artist Name \r\nSelect a Genre and Rating"
      );
    } else {
      this.setState((prevState) => ({
        songItems: [...prevState.songItems, { ...newSongId, ...newSongInput }],
        filteredSongItems: [
  ...
  handleSelectDisplayGenre(event) {
    ...
    if (value === "") {
      ...
      this.setState(
        ...
        this.setState({
          filteredSongItems: this.state.songItems.filter(
  ...
  sortSongList(property) {
    if (this.state.lastSort === "descending") {
      ...
      this.setState({
        filteredSongItems: sortedAscending,
        lastSort: "ascending",
      });
    } else {
      ...
      this.setState({
        filteredSongItems: sortedDescending,
        lastSort: "descending",
      });
    }
  }
